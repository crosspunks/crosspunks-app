            ...
            <div class="App">
                <nav style="margin-bottom: 50px;" class="navbar navbar-expand-lg navbar-light ">
                    <div class="container">
                        ...
                        <button @click="toggleCollapse" aria-controls="responsive-navbar-nav" type="button" aria-label="Toggle navigation" class="navbar-toggler collapsed">
